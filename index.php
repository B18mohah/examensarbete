...
<p>
      <label for="forbrukningstyp">forbrukningstyp </label>
          <input type="text" class="form-control" name="forbrukningstyp" id="forbrukningstyp" placeholder=" forbrukningstyp " value="" required>

     
    </p>
      <p>
      <label for="nyckelkod">nyckelkod</label>
       <input type="text"  class="forbrukningstyp" name="nyckelkod" id="nyckelkod" placeholder="nyckelkod" value="" required>

    </p>
    <p>
      <label for="varde">värde</label>
       <input type="text"  class="varde" name="varde" id="varde" placeholder="värde" value="" required>
    ...
    <p>
     ...
     <p>
      ...
      <input type="text"  class="detaljniva" name="detaljniva" id="detaljniva" placeholder="detaljnivå" value="" required>
    </p>
